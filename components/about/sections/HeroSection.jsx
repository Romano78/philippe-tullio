    ...
    <section className="relative z-10 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] lg:min-h-[85svh]">
        <div className="flex flex-col site-px pt-24 md:pt-36 pb-12 md:pb-16 lg:min-h-[85svh]">
          <div>
            <p className="font-meta text-xs tracking-widest uppercase text-white/30 mb-8">{t('overline')}</p>
          ...
          <div className="mt-10 lg:mt-auto">
            <p className="font-sans text-lg md:text-xl text-white/55 leading-relaxed max-w-lg mb-8">{t('intro')}</p>
            <PillCta href={routes.contact} icon="→">{t('cta')}</PillCta>
          </div>
        </div>
        <div className="overflow-hidden aspect-[4/3] lg:aspect-[3/4]">
          {portrait[0]
            ? <img src={portrait[0]} alt="Philippe Tullio — réalisateur" className="w-full h-full object-cover object-center" loading="eager" />
